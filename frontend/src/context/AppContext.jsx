...
export function AppProvider({ children }) {
  ...
  useEffect(() => {
    // 1. Initial fetch from queue API or Supabase
    const fetchQueue = async () => {
      // Try backend Express API first (guaranteed server admin access)
      try {
        ...
        console.warn('API initial queue fetch fallback:', apiErr);
      }
